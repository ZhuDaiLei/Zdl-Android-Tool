 ...
 * description LinearLayout渐变背景
 */
class DrawableBgLinearLayout(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    init {
        val ta = context.obtainStyledAttributes(attrs, R.styleable.DrawableBgLinearLayout)
        strokeColor = ta.getColor(R.styleable.DrawableBgLinearLayout_strokeColor, Int.MIN_VALUE)
        strokeWidth = ta.getDimension(R.styleable.DrawableBgLinearLayout_strokeWidth, 1F)
        dashWidth = ta.getDimension(R.styleable.DrawableBgLinearLayout_dashWidth, -1F)
        dashGap = ta.getDimension(R.styleable.DrawableBgLinearLayout_dashGap, -1F)
        topLeftRadius = ta.getDimension(R.styleable.DrawableBgLinearLayout_topLeftRadius, 0F)
        topRightRadius = ta.getDimension(R.styleable.DrawableBgLinearLayout_topRightRadius, 0F)
        bottomRightRadius =
            ta.getDimension(R.styleable.DrawableBgLinearLayout_bottomRightRadius, 0F)
        bottomLeftRadius = ta.getDimension(R.styleable.DrawableBgLinearLayout_bottomLeftRadius, 0F)
        radius = ta.getDimension(R.styleable.DrawableBgLinearLayout_radius, 0F)
        if (ta.getBoolean(R.styleable.DrawableBgLinearLayout_isGradient, false)) {
            //gradient，渐变色
            startColor = ta.getColor(R.styleable.DrawableBgLinearLayout_startColor, Color.WHITE)
            centerColor = ta.getColor(R.styleable.DrawableBgLinearLayout_centerColor, Int.MIN_VALUE)
            endColor = ta.getColor(R.styleable.DrawableBgLinearLayout_endColor, Color.WHITE)
            ...
            gradientRadius = ta.getDimension(R.styleable.DrawableBgLinearLayout_gradientRadius, 0F)
            ...
            fillColor = ta.getColor(R.styleable.DrawableBgLinearLayout_fillColor, Color.WHITE)
            when (shape) {
